...
uses Sockets, USearchServer, UMyNetPcInfo, UMyMaster, Menus, classes, Controls;
...
{$Region ' 本机信息 数据修改 ' }
  ...
  public
    ...
    Account, Password, ServerIp, ServerSocket : string;
    IsLogin : Boolean;
  public
    ...
    procedure SetAccountServer( _ServerIp, _ServerSocket : string );
  ...
  private
    ...
    // 设置 帐号信息
  TMyPcInfoSetAccountHandle = class
  public
    Account, Password : string;
    ServerIp, ServerSocket : string;
  public
    constructor Create( _Account, _Password : string );
    procedure SetServerInfo( _ServerIp, _ServerSocket : string );
    procedure Update;
  private
    procedure SetToInfo;
    procedure SetToXml;
    ...
    // 设置 是否已登录
  TMyPcInfoSetIsLoginHandle = class
  public
    IsLogin : Boolean;
  public
    constructor Create( _IsLogin : Boolean );
    procedure Update;
  private
    procedure SetToInfo;
    procedure SetToXml;
  ...
  public
    ...
    class procedure SetAccountInfo( Account, Password, ServerIp, ServerSocket : string );
    class procedure SetIsLogin( IsLogin : Boolean );
  end;
...
{$Region ' Server Login 修改 ' }

    // 修改
  TServerIpWriteHandle = class
  public
    Ip : string;
  public
    ...
    // 添加
  TServerIpAddHandle = class( TServerIpWriteHandle )
  public
    procedure Update;
  private
    procedure AddToFace;
...
{$EndRegion}
  ...
  public
    class procedure ShowServerNotConn;
    class procedure HideServerNotConn;
  end;
  ...
  public
    ...
    // 服务器 Ip
  NetworkServerIpApi = class
  public
    class procedure AddServer( Ip, CloudName : string );
    class procedure RemoveServer( Ip : string );
    class procedure ClearServer;
  public
    class function ReadFirstServer : string;
  end;

    // 网络帐号信息
  NetworkAccountApi = class
  public
    class procedure AddAccount( Server, Account : string );
    class procedure RemoveAccount( Server, Account : string );
  public
    class procedure AddAccountPath( Server, Account, BackupPath : string );
    class procedure RemoveAccountPath( Server, Account, BackupPath : string );
  public
    class procedure SetRemoteCopyCount( CopyCount : Integer );
    class procedure SetLocalCopyCount( CopyCount : Integer );
  public
    class procedure LoginAgain;
  end;

    // 改密码
  NetworkAccountMsgApi = class
  public
    class procedure ChangePassword( Account, Password : string );
  end;
...
uses  UNetworkFace, UMainForm, UNetPcInfoXml, UFormSetting, UNetworkEventInfo, UMyUtil,
      USettingInfo, UFormLogin, UChangeInfo, UMyClient, UMainFormFace, SysUtils;
...
procedure TMyPcInfoReadHandle.SetAccountInfo(_Account, _Password: string);
begin
  Account := _Account;
  Password := _Password;
end;

procedure TMyPcInfoReadHandle.SetAccountServer(_ServerIp,
  _ServerSocket: string);
begin
  ServerIp := _ServerIp;
  ServerSocket := _ServerSocket;
end;

procedure TMyPcInfoReadHandle.SetIsLogin(_IsLogin: Boolean);
begin
  IsLogin := _IsLogin;
end;
...
var
  ...
  AccountSetFace : TAccountSetFace;
begin
    // 本机信息
  ...
  MyPcInfoRaadFace.AddChange;
    ...
    // 帐号信息
  AccountSetFace := TAccountSetFace.Create( Account, Password, ServerSocket );
  AccountSetFace.AddChange;
...
begin
  ...
  PcInfo.Account := Account;
  PcInfo.Password := Password;
  PcInfo.ServerIp := ServerIp;
  PcInfo.IsLogin := IsLogin;
...
class procedure MyPcInfoApi.SetAccountInfo(Account, Password, ServerIp, ServerSocket: string);
var
  MyPcInfoSetAccountHandle : TMyPcInfoSetAccountHandle;
begin
  MyPcInfoSetAccountHandle := TMyPcInfoSetAccountHandle.Create( Account, Password );
  MyPcInfoSetAccountHandle.SetServerInfo( ServerIp, ServerSocket );
  MyPcInfoSetAccountHandle.Update;
  MyPcInfoSetAccountHandle.Free;
end;
...
class procedure MyPcInfoApi.SetIsLogin(IsLogin: Boolean);
var
  MyPcInfoSetIsLoginHandle : TMyPcInfoSetIsLoginHandle;
begin
  MyPcInfoSetIsLoginHandle := TMyPcInfoSetIsLoginHandle.Create( IsLogin );
  MyPcInfoSetIsLoginHandle.Update;
  MyPcInfoSetIsLoginHandle.Free;
end;
...
class procedure NetworkStatusApi.HideServerNotConn;
var
  ServerNotConnHideFace : TServerNotConnHideFace;
begin
  ServerNotConnHideFace := TServerNotConnHideFace.Create;
  ServerNotConnHideFace.AddChange;
end;
...
class procedure NetworkStatusApi.ShowServerNotConn;
var
  ServerNotConnShowFace : TServerNotConnShowFace;
begin
  ServerNotConnShowFace := TServerNotConnShowFace.Create;
  ServerNotConnShowFace.AddChange;
end;
...
{ TServerIpWriteHandle }

constructor TServerIpWriteHandle.Create(_Ip: string);
begin
  Ip := _Ip;
end;
...
procedure TServerIpAddHandle.AddToFace;
var
  ServerIpAddFace : TServerIpAddFace;
begin
  ServerIpAddFace := TServerIpAddFace.Create( Ip );
  ServerIpAddFace.AddChange;
end;

procedure TServerIpAddHandle.Update;
begin
  AddToFace;
end;
...
class procedure NetworkServerIpApi.AddServer(Ip, CloudName: string);
begin
  MyFaceChange.Sync(
  procedure
  begin
    frmLogin.AddIpToFace( Ip, CloudName, True );
  end);
end;

class procedure NetworkServerIpApi.ClearServer;
var
  ServerIpClearFace : TServerIpClearFace;
begin
  ServerIpClearFace := TServerIpClearFace.Create;
  ServerIpClearFace.AddChange;
end;

class function NetworkServerIpApi.ReadFirstServer: string;
var
  ServerIpReadFirst : TServerIpReadFirst;
begin
  ServerIpReadFirst := TServerIpReadFirst.Create;
  Result := ServerIpReadFirst.get;
  ServerIpReadFirst.Free;
end;

class procedure NetworkServerIpApi.RemoveServer(Ip: string);
begin
  MyFaceChange.Sync(
  procedure
  begin
    frmLogin.RemoveIpFromFace( Ip );
  end);
end;

{ TMyPcInfoSetAccountHandle }

constructor TMyPcInfoSetAccountHandle.Create(_Account, _Password: string);
begin
  Account := _Account;
  Password := _Password;
end;

procedure TMyPcInfoSetAccountHandle.SetServerInfo(_ServerIp,
  _ServerSocket: string);
begin
  ServerIp := _ServerIp;
  ServerSocket := _ServerSocket;
...
procedure TMyPcInfoSetAccountHandle.SetToFace;
var
  AccountNameSetFace : TAccountNameSetFace;
begin
  AccountNameSetFace := TAccountNameSetFace.Create( Account );
  AccountNameSetFace.AddChange;
end;

procedure TMyPcInfoSetAccountHandle.SetToInfo;
begin
  PcInfo.SetAccountInfo( Account, Password, ServerIp );
end;

procedure TMyPcInfoSetAccountHandle.SetToXml;
var
  MyPcInfoSetAccountXml : TMyPcInfoSetAccountXml;
begin
  MyPcInfoSetAccountXml := TMyPcInfoSetAccountXml.Create( Account, Password );
  MyPcInfoSetAccountXml.SetServerInfo( ServerIp, ServerSocket );
  MyPcInfoSetAccountXml.AddChange;
end;

procedure TMyPcInfoSetAccountHandle.Update;
begin
  SetToInfo;
  SetToXml;
  SetToFace;
...
constructor TAccountWriteHandle.Create( _ServerIp, _AccountName : string );
begin
  ServerIp := _ServerIp;
...
begin
  AccountAddInfo := TAccountAddInfo.Create( ServerIp, AccountName );
...
begin
  AccountAddXml := TAccountAddXml.Create( ServerIp, AccountName );
...
begin
  AccountRemoveInfo := TAccountRemoveInfo.Create( ServerIp, AccountName );
...
begin
  AccountRemoveXml := TAccountRemoveXml.Create( ServerIp, AccountName );
...
class procedure NetworkAccountApi.AddAccount(Server, Account: string);
var
  AccountAddHandle : TAccountAddHandle;
begin
  AccountAddHandle := TAccountAddHandle.Create( Server, Account );
...
class procedure NetworkAccountApi.AddAccountPath(Server, Account, BackupPath: string);
var
  BackupListAddHandle : TBackupListAddHandle;
begin
  BackupListAddHandle := TBackupListAddHandle.Create( Server, Account );
...
class procedure NetworkAccountApi.LoginAgain;
var
  AccountLoginAgainFace : TAccountLoginAgainFace;
begin
    // 设置未登录
  MyPcInfoApi.SetIsLogin( False );

    // 进入局域网
  NetworkModeApi.EnterLan;

    // 显示登录窗口
  AccountLoginAgainFace := TAccountLoginAgainFace.Create;
  AccountLoginAgainFace.AddChange;
end;

class procedure NetworkAccountApi.RemoveAccount(Server, Account: string);
var
  AccountRemoveHandle : TAccountRemoveHandle;
begin
  AccountRemoveHandle := TAccountRemoveHandle.Create( Server, Account );
  AccountRemoveHandle.Update;
  AccountRemoveHandle.Free;
end;

class procedure NetworkAccountApi.RemoveAccountPath(Server, Account,
  BackupPath: string);
var
  BackupListRemoveHandle : TBackupListRemoveHandle;
begin
  BackupListRemoveHandle := TBackupListRemoveHandle.Create( Server, Account );
...
class procedure NetworkAccountApi.SetLocalCopyCount(CopyCount: Integer);
var
  NetStatusCopyCountInfo : TNetStatusCopyCountInfo;
  SetttingCopyQtyInfo : TSetttingCopyQtyInfo;
begin
  PcInfo.CopyCount := CopyCount;

  NetStatusCopyCountInfo := TNetStatusCopyCountInfo.Create( IntToStr( CopyCount ) );
  NetStatusCopyCountInfo.AddChange;

  SetttingCopyQtyInfo := TSetttingCopyQtyInfo.Create;
  SetttingCopyQtyInfo.SetCopyCount( PcInfo.CopyCount );
  SetttingCopyQtyInfo.AddChange;
end;

class procedure NetworkAccountApi.SetRemoteCopyCount(CopyCount: Integer);
var
  AccountSetCopyAccountMsg : TAccountSetCopyAccountMsg;
begin
  AccountSetCopyAccountMsg := TAccountSetCopyAccountMsg.Create;
  AccountSetCopyAccountMsg.SetAccount( PcInfo.Account );
  AccountSetCopyAccountMsg.SetCopyCount( CopyCount );
  MyClient.SendMsgToAll( AccountSetCopyAccountMsg );

  NetworkAccountApi.SetLocalCopyCount( CopyCount );
end;
...
begin
  BackupListAddInfo := TBackupListAddInfo.Create( ServerIp, AccountName );
...
begin
  BackupListAddXml := TBackupListAddXml.Create( ServerIp, AccountName );
...
begin
  BackupListRemoveInfo := TBackupListRemoveInfo.Create( ServerIp, AccountName );
...
begin
  BackupListRemoveXml := TBackupListRemoveXml.Create( ServerIp, AccountName );
...
{ TMyPcInfoSetIsLoginHandle }

constructor TMyPcInfoSetIsLoginHandle.Create(_IsLogin: Boolean);
begin
  IsLogin := _IsLogin;
end;

procedure TMyPcInfoSetIsLoginHandle.SetToInfo;
begin
  PcInfo.IsLogin := IsLogin;
end;

procedure TMyPcInfoSetIsLoginHandle.SetToXml;
var
  MyPcInfoSetIsLoginXml : TMyPcInfoSetIsLoginXml;
begin
  MyPcInfoSetIsLoginXml := TMyPcInfoSetIsLoginXml.Create( IsLogin );
  MyPcInfoSetIsLoginXml.AddChange;
end;

procedure TMyPcInfoSetIsLoginHandle.Update;
begin
  SetToInfo;
  SetToXml;
end;

{ NetworkAccountMsgApi }

class procedure NetworkAccountMsgApi.ChangePassword(Account, Password: string);
var
  AccountChangePasswordMsg : TAccountChangePasswordMsg;
begin
  AccountChangePasswordMsg := TAccountChangePasswordMsg.Create;
  AccountChangePasswordMsg.SetAccount( Account );
  AccountChangePasswordMsg.SetPassword( Password );
  MyClient.SendMsgToAll( AccountChangePasswordMsg );
end;
