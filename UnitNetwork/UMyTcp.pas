...
{$EndRegion}
  ...
  public
    ...
    class function ReadCloudName( Ip, Port : string ): string;
  end;
...
const
  ...
  ConnType_ReadCloudName = 'ReadCloudName';
...
const    // Connect to computer
  ...
  JsonMsgType_Account_Enter = 'Account_Enter';
...
const
  JsonMsgType_AccountName = 'AccountName';
  JsonMsgType_AccountPassword = 'AccountPassword';

const
  JsonMsgType_SignupAccount = 'SignupAccount';
  JsonMsgType_SignupPassword = 'SignupPassword';
...
class function MyTcpUtil.ReadCloudName(Ip, Port: string): string;
var
  TcpSocket : TCustomIpClient;
...
begin
  ...
  MyTcpConn.SetConnType( ConnType_ReadCloudName );
