...
begin
  ...
  SetStatus( RestorePath, OwnerPcID, RestoreFrom, LanguageInfo.frmMain_RestoreNodeStatus_Restoreing );
end;

class procedure RestoreDownAppApi.WaitingRestore(RestorePath,
  OwnerPcID, RestoreFrom: string);
begin
  SetStatus( RestorePath, OwnerPcID, RestoreFrom, LanguageInfo.frmMain_RestoreNodeStatus_WaitingRestore );
end;
...
begin
  ...
  RestoreDownAppApi.SetIsRestoring( RestorePath, OwnerPcID, RestoreFrom, False );
    ...
    // 设置 界面状态为空
  RestoreDownAppApi.SetStatus( RestorePath, OwnerPcID, RestoreFrom, LanguageInfo.frmMain_RestoreNodeStatus_Empty );
end;
...
begin
  Params.ErrorStatus := LanguageInfo.frmMain_RestoreNodeStatus_LostConnectFileError;
  AddItem( Params );
end;
...
class procedure RestoreDownErrorApi.ReadFileError(
  Params: TRestoreDownErrorAddParams);
begin
  Params.ErrorStatus := LanguageInfo.frmMain_RestoreNodeStatus_ReadFileError;
  AddItem( Params );
end;
...
class procedure RestoreDownErrorApi.ReceiveFileError(
  Params: TRestoreDownErrorAddParams);
begin
  Params.ErrorStatus := LanguageInfo.frmMain_RestoreNodeStatus_ReceiveFileError;
  AddItem( Params );
end;
...
class procedure RestoreDownErrorApi.WriteFileError(
  Params: TRestoreDownErrorAddParams);
begin
  Params.ErrorStatus := LanguageInfo.frmMain_RestoreNodeStatus_WriteFileError;
  AddItem( Params );
end;
...
begin
  ...
  RestoreDownAppApi.SetScaningCount( RestorePath, OwnerPcID, RestoreFrom, 0 );
    ...
    // 设置状态
  RestoreDownAppApi.SetStatus( RestorePath, OwnerPcID, RestoreFrom, LanguageInfo.frmMain_RestoreNodeStatus_Analyizing );
