...
begin
  ...
  NetworkBackupAddMsg.SetAccount( PcInfo.Account );
  MyClient.SendMsgToAll( NetworkBackupAddMsg );
end;
...
begin
  ...
  NetworkBackupRemoveMsg.SetAccount( PcInfo.Account );
  MyClient.SendMsgToAll( NetworkBackupRemoveMsg );
end;
