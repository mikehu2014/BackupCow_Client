...
begin
  ...
  AnalyzeResetHandle.SetDesItemID( DesItemID );
...
begin
  ...
  for i := 0 to BackupSpaceList.Count - 1 do
    FileExtList.Add( BackupSpaceList[i].TypeName );
  BackupItemUserApi.SetFileExtList( DesItemID, BackupPath, FileExtList );
  FileExtList.Free;
end;
...
procedure TAnalyzeResetHandle.SetDesItemID(_DesItemID: string);
begin
  DesItemID := _DesItemID;
end;
