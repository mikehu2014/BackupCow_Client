...
{$Region ' 数据结构 ' }
  ...
  public  // 过滤器
    ...
    FileExtList : TStringList; // 文件后缀列表
  public  // 续传信息
...
{$Region ' 备份信息 数据修改 ' }
  ...
  public
    ...
    // 设置
  TBackupItemFileExtSetInfo = class( TBackupItemAccessInfo )
  private
    NewFileExtList : TStringList;
  public
    procedure SetNewFileExtList( _NewFileExtList : TStringList );
    procedure Update;
  end;
...
{ TBackupItemFileExtSetInfo }

procedure TBackupItemFileExtSetInfo.SetNewFileExtList(_NewFileExtList: TStringList);
begin
  NewFileExtList := _NewFileExtList;
end;

procedure TBackupItemFileExtSetInfo.Update;
var
...
begin
  if not FindBackupItemInfo then
    Exit;
  FileExtList := BackupItemInfo.FileExtList;
  FileExtList.Clear;
