program BackupCowCloudCn_Client;
...
uses
  ...
  UServerNetwork in 'UnitNew\UServerNetwork.pas',
  UNetworkUtil in 'UnitNew\UNetworkUtil.pas',
  UClientNetwork in 'UnitNew\UClientNetwork.pas',
  ...
  UFormLogin in 'UnitNetwork\UFormLogin.pas' {frmLogin},
  UFormLogout in 'UnitNetwork\UFormLogout.pas' {frmLogout},
  UFormNewSettings in 'UnitMain\UFormNewSettings.pas' {frmNewSettings},
  UFormPasswordChange in 'UnitMain\UFormPasswordChange.pas' {frmChangePassword},
  ULanguageUtil in 'UnitUtil\ULanguageUtil.pas',
  ULanguageConst in 'UnitUtil\ULanguageConst.pas';
...
begin
  ...
  Application.CreateForm(TfrmNewSettings, frmNewSettings);
