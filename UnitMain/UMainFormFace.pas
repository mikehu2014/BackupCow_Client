...
{$Region ' Status Bar 界面更新 ' }
  ...
  public
    ...
    // 设置副本数
  TNetStatusCopyCountInfo = class( TStatusBarChangeInfo )
  public
    procedure Update;override;
  end;
...
{$Region ' Form New Settings ' }

    // 设置副本数
  TSetttingCopyQtyInfo = class( TFaceChangeInfo )
  private
    CopyCount : Integer;
  public
...
uses UMainForm, UFormHint, UDebugForm, UFormNewSettings;
...
{ TNetStatusCopyCountInfo }

procedure TNetStatusCopyCountInfo.Update;
begin
  frmMainForm.sbCopyCount.Caption := ShowStr;
end;

{ TSetttingCopyQtyInfo }

procedure TSetttingCopyQtyInfo.SetCopyCount(_CopyCount: Integer);
begin
  CopyCount := _CopyCount;
end;

procedure TSetttingCopyQtyInfo.Update;
begin
  inherited;
  frmNewSettings.edtCopyQuantity.Text := IntToStr( CopyCount );
end;
