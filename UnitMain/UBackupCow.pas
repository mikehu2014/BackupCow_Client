...
begin
  ...
  ParamList.Add( HttpReqTrial_Account + '=Cloud_Client' );
...
var
  ...
  MyAccountXmlRead : TMyAccountXmlRead;
begin
  try
  ...
  try
    MyAccountXmlRead := TMyAccountXmlRead.Create;
    MyAccountXmlRead.Update;
    MyAccountXmlRead.Free;
  except
  end;
...
begin
  ...
  params.Add( HttpMarkApp_Account + '=Cloud_Client' );
